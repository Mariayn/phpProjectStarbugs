    ...
    <body>
        ...
        <main>
            ...
            <section id="section-menu">
                ...
                <div id="divCaffee">
                    <div class="caffee-types">
                        <img class="caffeeImg" src="../images/caffe.png" alt="img-hot-coffee">
                        <a href="subCarta.php?select=hot coffes">Hot Caffees</a>
                    </div>
                    <div class="caffee-types">
                        <img class="caffeeImg" src="../images/PumpkinCreamColdBrew.png" alt="img-cold-coffee">
                        <a href="subCarta.php?select=cold coffes">Cold Caffees</a>
                    </div>
                </div>
