    ...
    <body>
      ...
      <header class="header">
        <nav><!--LOGO Y ENLACES-->
            ...
            <ul class="nav-links">
                <li><a class="nav-link" href="CONTROLADORES/ControladorGetCoffeeObj.php" class="text-bold">CARTA</a></li>
        ...
        <div class="btns"><!--BOTONES-->
            ...
            ?>
          <a class="btn" id="login" href="./VISTAS/account/login.php">Iniciar sesión</a> 
          <a class="btn btn--black" id="create" href="./VISTAS/account/create.php">Registrarse</a>
          <?php 
            }else{
          ?>
          <a class="btn" id="login" href="./VISTAS/account/perfilUsuario.php">Mi perfil</a> 
      ...
      <main>
        <section class="presentation">
          ...
          <div class="intro-text">
            <p>
              <strong>Bebidas deliciosas y artesanales.</strong> Alimentos de gran sabor, elaborados con ingredientes sencillos pero de gran calidad. El café está en nuestro corazón, y también lo están todas las formas en las que te llevamos la experiencia Starbugs
            </p>
            <a href="CONTROLADORES/ControladorGetCoffeeObj.php" class="cta-select">Pide Ahora</a>
          </div>

          <div class="cover">
            <img src="./images/hero2.png" alt="caffes">
          </div>
        ...
        <footer >
            <div class="container">
              ...
              <div class="footer__links col1">
                    ...
                    <a href="./VISTAS/formularioContacto.php">Contacto</a>
              </div>

              <div class="footer__links col2">
                  <a href="./VISTAS/trabajaConNosotros.php">Trabaja con nosotros</a>
                    <a href="./VISTAS/privacidad-politica.php">Política de Privacidad</a>
                    <a href="#">Información Nutricional</a>
              </div>
